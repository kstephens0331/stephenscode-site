...
export const premiumBuilds: Service[] = [
  {
    ...
    metaTitle: 'Premium Web Application Development | $2,000 | Full-Stack Solutions',
    metaDescription: 'Custom full-stack web application with admin portal, analytics dashboard, and advanced features. Enterprise-grade development. $2,000 flat rate. Houston & Conroe.',
  },
  {
    ...
    price: 5000,
    priceLabel: '$5,000',
    shortDescription: 'Complete business system: CRM, client portals, APIs, and long-term scalability',
    longDescription: `Build a complete custom business platform tailored to your exact needs. The $5,000 Custom Business Platform package is perfect for businesses that need a unified system to manage everything in one place. We build you a custom platform that includes CRM, client portals, project management, invoicing, and all the integrations you need—owned entirely by you. Stop paying monthly SaaS fees and get full control of your business operations with a system built specifically for how you work.`,
    features: [
      'Complete CRM system',
    ...
    metaDescription: 'Build a complete custom business platform with CRM, client portals, project management, and integrations. $5,000 flat rate. Houston & Conroe.',
  },
  {
    ...
    price: 7500,
    priceLabel: '$7,500',
    shortDescription: 'Large-scale tools: integrated admin, staff roles, automation, reports, and mobile support',
    longDescription: `Build an enterprise-grade platform that powers your entire organization. The $7,500 Enterprise Platform is designed for established businesses and organizations that need sophisticated systems with advanced automation, reporting, multi-location support, and mobile applications. This comprehensive solution includes everything from staff management and role-based access to automated workflows, advanced analytics, and integrations with your existing business tools.`,
    features: [
      ...
      'Custom AI/ML features (if applicable)',
    ...
    useCases: [
      ...
      'Businesses with mobile workforce',
    ],
    deliverables: [
    ...
    metaDescription: 'Enterprise-grade platform with admin systems, automation, mobile apps, and advanced features. Complete organizational solution. $7,500 flat rate. Houston & Conroe.',
  },
]
