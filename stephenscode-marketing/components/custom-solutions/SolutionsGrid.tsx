        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {solutions.map((solution, index) => (
            <motion.div
              ...
              className="group relative bg-surface-card rounded-2xl p-8 border border-surface-border card-lift"
            >
              ...
              <div className="relative">
                <solution.icon className="h-12 w-12 mb-4 text-primary-500" strokeWidth={1.75} />
