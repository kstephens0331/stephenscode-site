    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-surface-card rounded-3xl p-8 md:p-12 border-2 border-primary-500/30 shadow-2xl shadow-black/40 mb-12"
        >
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-5xl md:text-6xl font-bold text-white mb-4">
                $50<span className="text-2xl text-gray-400">/hour</span>
              </h3>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-xl border border-primary-500/40 bg-black flex items-center justify-center text-primary-500">
                ...
                <div>
                  ...
                  <p className="text-gray-300">You know exactly what you'll pay before we start. No hourly billing, no cost overruns.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">We don't log hours or bill you more if development takes longer than estimated. Your price is your price.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Your quote includes development, testing, deployment, and initial support. No hidden fees.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            <div className="w-12 h-12 rounded-xl border border-primary-500/40 bg-black flex items-center justify-center text-primary-500 mb-4">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h3 className="text-lg font-bold text-white mb-2">Detailed Proposals</h3>
            <p className="text-gray-300 text-sm">Every quote includes a full breakdown of features, timeline, and deliverables.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300 text-sm">We work with your schedule and can expedite projects when needed.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300 text-sm">Ongoing maintenance and support packages available after launch.</p>
          </motion.div>
        </div>
