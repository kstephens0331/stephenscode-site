    ...
    <section className="relative pt-32 pb-20 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute inset-0" style={{
          backgroundImage: 'radial-gradient(circle at 2px 2px, rgb(239 78 34 / 0.15) 1px, transparent 0)',
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-primary-400">Enterprise & Custom Development</span>
          </motion.div>
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            ...
            <br />
            <span className="text-primary-500">Built for Your Business</span>
          </h1>
