      ...
      {isOpen && (
        <div className="absolute bottom-16 right-0 mb-2 flex flex-col gap-3 animate-fade-in">
          ...
          <a
            ...
            className="flex items-center gap-3 rounded-full bg-surface-elevated ring-1 ring-surface-border pl-4 pr-6 py-3 text-white shadow-lg hover:bg-surface-border transition-all"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
