export default function LocalBusinessSchema() {
  ...
  const organizationSchema = {
    ...
    name: 'StephensCode',
    alternateName: ['StephensCode LLC', 'StephensCode Web Development', 'StephensCode MSP'],
    description: 'Veteran-owned technology company providing web development, managed IT services (MSP), and enterprise VPN solutions. Serving Houston, Conroe, and The Woodlands area businesses with custom websites, cybersecurity, and IT support.',
