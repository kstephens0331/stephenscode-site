...
interface PrecisionAutoRepairDemoProps {
  demo: Demo
  viewMode: 'customer' | 'admin'
}

export default function PrecisionAutoRepairDemo({ demo, viewMode }: PrecisionAutoRepairDemoProps) {
  const colors = getDemoColors('precision-auto-repair')
