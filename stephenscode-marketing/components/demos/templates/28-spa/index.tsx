...
interface SerenitySpaWellnessDemoProps {
  demo: Demo
  viewMode: 'customer' | 'admin'
}

export default function SerenitySpaWellnessDemo({ demo, viewMode }: SerenitySpaWellnessDemoProps) {
  const colors = getDemoColors('serenity-spa-wellness')
