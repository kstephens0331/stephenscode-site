...
const BuyerResourcesPage: React.FC = () => {
  ...
  const downloadResource = (index: number, title: string, description: string, type: string) => {
    const lines = [
      ...
      '',
      'WHAT IS INSIDE',
      '- Step-by-step guidance from our agent team',
      '- Worksheets you can fill in as you go',
      '- Questions to ask your lender and inspector',
      '- Local market context for every neighborhood we serve',
      '',
      'NEXT STEPS',
      '1. Review this resource at your own pace.',
      '2. Note any questions that come up.',
      '3. Call us at (555) 123-4567 or email info@skylinerealty.com.',
      '',
      'This sample document was generated by the Skyline Realty demo site.',
    ];
    ...
    setDownloaded((prev) => (prev.includes(index) ? prev : [...prev, index]));
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <button
                      onClick={() => downloadResource(index, resource.title, resource.description, resource.type)}
                      className={`flex items-center font-semibold transition-colors ${
                        downloaded.includes(index)
                          ? 'text-green-600 hover:text-green-700'
                          : 'text-[#000814] hover:text-[#001d3d]'
                      }`}
                    >
                      {downloaded.includes(index) ? (
                        <>
                          <CheckCircle className="w-4 h-4 mr-2" />
                          Downloaded - Get Again
                        </>
                      ) : (
                        <>
      ...
      <LeadModal
        ...
        title="Get Pre-Approved"
        subtitle="Tell us a little about your plans and our lending partners will follow up with next steps."
        service="Mortgage Pre-Approval"
        formName="pre_approval"
        submitLabel="Request Pre-Approval"
        messageLabel="Tell Us About Your Plans"
        messagePlaceholder="Target price range, timeline, first home or move-up..."
      />
