...
const clients: Client[] = [
  ...
  },
  {
    name: 'LotSwap',
    shortName: 'LotSwap',
    description: 'Fee-free dealer-to-dealer vehicle marketplace with real-time inventory management and direct negotiation tools.',
    longDescription: 'LotSwap is a dealer-to-dealer vehicle marketplace we built to eliminate traditional auction fees, transport costs, and holding expenses. The full-stack platform uses Next.js with Prisma, tRPC, and real-time Socket.io communication — enabling dealers to list wholesale inventory, search by make/model/year, negotiate directly, and close deals without middlemen. The platform saves dealers an average of $1,500 to $2,500 per vehicle compared to traditional auctions.',
    url: 'https://lotswap.io',
    industry: 'Automotive Technology',
    location: 'Nationwide',
    services: ['Custom SaaS Platform', 'Real-time Messaging', 'Search & Filtering', 'Payment Integration'],
    pageCount: 40,
    samplePages: ['/dashboard', '/inventory', '/search', '/deals', '/settings', '/about', '/faq'],
  },
  {
    name: 'GradeStack',
    shortName: 'GradeStack',
    description: 'Self-hosted SEO audit and website monitoring platform with automated crawling, scoring, and actionable fix recommendations.',
    longDescription: 'GradeStack is a self-hosted SEO audit and monitoring platform we built from the ground up. Using Puppeteer-powered crawling, it scores websites across performance, SEO, security, accessibility, and best practices — then provides step-by-step instructions to fix every issue found. Built with React, Express, PostgreSQL, and Redis, the platform replaces overpriced SaaS audit tools with a flat-rate, no-nonsense approach to website health monitoring.',
    url: 'https://gradestack.dev',
    industry: 'SEO Technology',
    location: 'Nationwide',
    services: ['Custom SaaS Platform', 'Automated Crawling', 'Score Tracking', 'Admin Dashboard'],
    pageCount: 15,
    samplePages: ['/dashboard', '/site', '/settings', '/admin'],
  },
  {
    name: 'Get Step Ready',
    shortName: 'Get Step Ready',
    description: 'Comprehensive USMLE Step 1 study platform with flashcards, practice questions, video lectures, and AI-powered learning tools.',
    longDescription: 'Get Step Ready is a comprehensive study platform we developed to help medical students pass the USMLE Step 1 board exam. The learning management system features 50,000+ flashcards, 5,000+ practice questions, video lecture integration, and AI-powered study tools that adapt to each student\'s learning pace. The platform gives future physicians everything they need to prepare for their boards with confidence.',
    url: 'https://getstepready.com',
    industry: 'Education Technology',
    location: 'Nationwide',
    services: ['Learning Platform', 'AI Integration', 'Content Management', 'Progress Tracking'],
    pageCount: 30,
