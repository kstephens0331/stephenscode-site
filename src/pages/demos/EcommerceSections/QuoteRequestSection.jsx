  ...
  return (
    <section className="py-20 px-6 bg-gray-50 text-gray-800" id="quote">
      <div className="max-w-3xl mx-auto">
        ...
        >
          Custom Order & Wholesale Inquiries
        </motion.h2>
        ...
        >
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block mb-1 text-sm font-medium">Business Email</label>
              <input
                type="email"
          ...
          <div>
            ...
            <select className="w-full border rounded p-3 focus:outline-none focus:ring-2 focus:ring-orange-400">
              ...
              <option>Bulk Custom Items</option>
            </select>
          </div>

          <div>
            <label className="block mb-1 text-sm font-medium">Message / Order Details</label>
            <textarea
              rows="4"
