...
const services = [
  { title: "Camera Systems", icon: <FaVideo /> },
  { title: "Alarm Installation", icon: <FaBell /> },
  { title: "24/7 Monitoring", icon: <FaShieldAlt /> },
  { title: "Smart Home Integration", icon: <FaWifi /> },
  { title: "Mobile Control Access", icon: <FaMobileAlt /> },
  { title: "Entry Access Control", icon: <FaLock /> },
];
